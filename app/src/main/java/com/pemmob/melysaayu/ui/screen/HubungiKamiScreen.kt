...
fun HubungiKamiScreen(navController: NavController?) {
    ...
    // Langkah 8: Deklarasi Variabel untuk teks
    var emailText by remember { mutableStateOf(value = "") }
    var messageText by remember { mutableStateOf(value = "") }

    // Langkah G.1: Deklarasi Variabel untuk SnackBar
    val scope = rememberCoroutineScope()
    val snackbarHostState = remember { SnackbarHostState() }

    // Langkah 9: Membuat Scaffold
    Scaffold(
        // Ini wajib ditambahkan agar SnackBar punya tempat untuk muncul
        snackbarHost = {
        ...
        Column(
            ...
            // Langkah G.2: Memanggil Function showSnackbar pada onClick Button
            Button(
                onClick = {
                    // Menjalankan proses asinkron untuk memunculkan pesan
                    scope.launch {
